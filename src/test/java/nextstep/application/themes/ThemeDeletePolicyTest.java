...
class ThemeDeletePolicyTest {
  ...
  void 예약되어있는_테마_삭제시_예외가_발생한다() {
    //given
    var themeId = 1L;
    var sut = new ThemeDeletePolicy(List.of(new ThemeDeleteAssignedReservationValidation(reservationService)));
    given(reservationService.getReservationByThemeId(themeId)).willReturn(
